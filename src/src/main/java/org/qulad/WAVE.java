...
public class WAVE {
    ...
    private WAVE(String path) {
        ...
        decoded = new AudioFormat(encoding, sampleRate,
            ...
            while (audioInputStreamDecoded.read(rawData) != -1) {
                ...
                for (int i = 0; i < totalFrameLength; i++) {
                    ...
                    if (numChannels == DUAL_CHANNEL) {
                        ...
                        rightChannelBytes = Arrays.copyOfRange(arrayFrameSlice, bytesPerFrame / 2, arrayFrameSlice.length);
    ...
    public XYChart.Series<Double,Double> getMonoSeries() { return monoSeries;}
    public XYChart.Series<Double,Double> getLeftChannelSeries() { return  leftChannelSeries; }
    public XYChart.Series<Double,Double> getRightChannelSeries() { return rightChannelSeries; }
    public XYChart.Series<Double,Double> getMonoTransformedSeries() { return monoTransformedSeries;}
    public XYChart.Series<Double,Double> getLeftTransformedSeries(){return leftTransformedSeries;}
    public XYChart.Series<Double,Double> getRightTransformedSeries(){return rightTransformedSeries;}
    public int getNumChannels() { return numChannels; }
    public int getTotalNumberOfSamples() { return totalNumberOfSamples;}
